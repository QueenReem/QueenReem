...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1228539327,1228539327}
...
local UserName = (data.username_ or "QueenReem")
...
local UserName = (b.username_ or "QueenReem")
...
Srrt = https.request('https://QueenReem-source.tk/QueenReem/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if DevQueenReem(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/QueenReem/Files_QueenReem/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/QueenReem/Files_QueenReem/master/Files_QueenReem/"..file)
if res == 200 then
...
{text = URL.escape(titlech),url='https://telegram.me/'..database:get(bot_id..'add:ch:username'):gsub("@","")}}}   
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape('*˛ ??𝗂 𝖻𝗋𝗈 𝗒𝗈𝗎 𝗁𝖺𝗏𝖾 𝗍𝗈 𝗌𝗎𝖻𝗌𝖼𝗋𝗂𝖻𝖾 𝗍𝗈 𝗍𝗁𝖾 𝖻𝗈𝗍 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 .*').."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Teext =[[
𝙒𝙚𝙡𝘾𝙤𝙢𝙚 𝙏𝙤 𝙎𝙤𝙪𝙍𝙘𝙚 [𓌹 𝗊𝗎𝖾𝖾𝗇 𝗋𝖾𝖾𝗆 𓌺 🦇](t.me/Deett54)
