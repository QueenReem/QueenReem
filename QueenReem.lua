...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1228539327,1878154430}
...
io.popen("mkdir QueenReem_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls QueenReem_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."QueenReem:Sudo:User", msg.sender_user_id_) 
if hash or Bot(msg) or DevQueenReem(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or DevBot(msg) or DevQueenReem(msg) or VIP_DeV(msg) then    
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevQueenReem(msg) or DevBot(msg) or VIP_DeV(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."QueenReem:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevQueenReem(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then        
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."QueenReem:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevQueenReem(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) or creatorA(msg) then        
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."QueenReem:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevQueenReem(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."QueenReem:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevQueenReem(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
...
function Vips(msg)
local hash = database:sismember(bot_id.."QueenReem:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or Bot(msg) or  DevQueenReem(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
function CleangGroups();local z = io.open('./QueenReem');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/QueenReem.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
function General_ban(user_id,chat_id)
if DevQueenReeme(user_id) == true then
var = true
elseif DevQueenReem(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1228539327) then  
var = true  
...
var = true  
elseif database:sismember(bot_id.."QueenReem:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."creator"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."QueenReem:Basic:Constructor"..chat_id, user_id) then
var = true                 
elseif database:sismember(bot_id.."QueenReem:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."QueenReem:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."QueenReem:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."QueenReem:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."QueenReem:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
elseif tonumber(user_id) == tonumber(11110) then  
var = "مبرمج السورس"  
elseif DevQueenReeme(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then  var = "مطور اساسي ثانوي"  
elseif database:sismember(bot_id.."QueenReem:Sudo:User", user_id) then
var = database:get(bot_id.."QueenReem:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."creator"..chat_id,user_id) then var = "المالك"
elseif database:sismember(bot_id.."QueenReem:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."QueenReem:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."QueenReem:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."QueenReem:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."QueenReem:Manager"..chat_id, user_id) then
var = database:get(bot_id.."QueenReem:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."QueenReem:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."QueenReem:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."QueenReem:MN:TF"..chat_id, user_id) then
var =  "منظف"  
elseif database:sismember(bot_id.."QueenReem:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."QueenReem:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."QueenReem:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."QueenReem:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."QueenReem:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."QueenReem:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."QueenReem:GBan:User",User_id) then
Var = true
else
Var = false
end
...
local listsudo = database:smembers(bot_id.."QueenReem:Sudo:User"..chat_id)
local listasa = database:smembers(bot_id.."QueenReem:Basic:Constructor"..chat_id)
local listmnsh = database:smembers(bot_id.."QueenReem:Constructor"..chat_id)
local listmder = database:smembers(bot_id.."QueenReem:Manager"..chat_id)
local listadmin = database:smembers(bot_id.."QueenReem:Mod:User"..chat_id)
local listvip = database:smembers(bot_id.."QueenReem:Special:User"..chat_id)
local listbans = database:smembers(bot_id.."QueenReem:GBan:User")
local listban = database:smembers(bot_id.."QueenReem:Ban:User"..chat_id)
local listktm = database:smembers(bot_id.."QueenReem:Muted:User"..chat_id)
local listcleanerr = database:smembers(bot_id.."QueenReem:MN:TF"..chat_id)
local listCmdd = database:smembers(bot_id.."QueenReem:List:Cmd:Group:New"..chat_id)
...
duration_ = "",
title_ = title or "",
performer_ = "سورس كوين ريم الرسمي",
caption_ = caption or ""
}},func or dl_cb,nil)
end
...
local mute_photo = (database:get(bot_id.."QueenReem:Lock:Photo"..chat) or '❌')
local mute_photo1 = mute_photo:gsub('del', '❬ ✅ ❭')
local mute_audio = (database:get(bot_id.."QueenReem:Lock:vico"..chat) or '❌')
local mute_audio1 = mute_audio:gsub('del', '❬ ✅ ❭')
local mute_voice = (database:get(bot_id.."QueenReem:Lock:Audio"..chat) or '❌')
local mute_voice1 = mute_voice:gsub('del', '❬ ✅ ❭')
local mute_forward = (database:get(bot_id.."QueenReem:Lock:forward"..chat) or '❌')
local mute_forward1 = mute_forward:gsub('del', '❬ ✅ ❭')
local mute_document = (database:get(bot_id.."QueenReem:Lock:Document"..chat) or '❌')
local mute_document1 = mute_document:gsub('del', '❬ ✅ ❭')
local mute_contact = (database:get(bot_id.."QueenReem:Lock:Contact"..chat) or '❌')
local mute_contact1 = mute_contact:gsub('del', '❬ ✅ ❭')
local lock_spam = (database:get(bot_id.."QueenReem:Lock:Spam"..chat) or '❌')
local lock_spam1 = lock_spam:gsub('del', '❬ ✅ ❭')
local lock_flood = (database:hget(bot_id.."QueenReem:flooding:settings:"..chat ,"flood") or '❌')
local lock_flood1 = lock_flood:gsub('del', '❬ ✅ ❭')
local mute_inline = (database:get(bot_id.."QueenReem:Lock:Inlen"..chat) or '❌')
...
local Texti = 'تستطيع قفل وفتح عبر الازرار'
local mute_text = (database:get(bot_id.."QueenReem:Lock:text"..chat)  or '❌')
local mute_text1 = mute_text:gsub('true', '❬ ✅ ❭')
local lock_bots = (database:get(bot_id.."QueenReem:Lock:Bot:kick"..chat) or '❌')
local lock_bots1 = lock_bots:gsub('kick', '❬ ✅ ❭')
local mute_tgservice = (database:get(bot_id.."QueenReem:Lock:tagservr"..chat) or '❌')
local mute_tgservice1 = mute_tgservice:gsub('true', '❬ ✅ ❭')
local lock_edit = (database:get(bot_id.."QueenReem:Lock:edit"..chat) or '❌')
local lock_edit1 = lock_edit:gsub('true', '❬ ✅ ❭')
local lock_link = (database:get(bot_id.."QueenReem:Lock:Link"..chat) or '❌')
local lock_link1 = lock_link:gsub('del', '❬ ✅ ❭')
local lock_username = (database:get(bot_id.."QueenReem:Lock:User:Name"..chat) or '❌')
local lock_username1 = lock_username:gsub('del', '❬ ✅ ❭')
local lock_tag = (database:get(bot_id.."QueenReem:Lock:hashtak"..chat) or '❌')
local lock_tag1 = lock_tag:gsub('del', '❬ ✅ ❭')
local mute_sticker = (database:get(bot_id.."QueenReem:Lock:Sticker"..chat) or '❌')
local mute_sticker1 = mute_sticker:gsub('del', '❬ ✅ ❭')
local mute_gif = (database:get(bot_id.."QueenReem:Lock:Animation"..chat) or '❌')
local mute_gif1 = mute_gif:gsub('del', '❬ ✅ ❭')
local mute_video = (database:get(bot_id.."QueenReem:Lock:Video"..chat) or '❌')
...
local UserName = (data.username_ or "malakAlDleMQueenReem007")
...
database:sadd(bot_id..'QueenReem:Chek:Groups',idg) 
database:set(bot_id.."QueenReem:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'QueenReem:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."QueenReem:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."QueenReem:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."QueenReem:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."QueenReem:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
...
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function QueenReem_Files(msg)
for v in io.popen('ls QueenReem_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("QueenReem_Files/"..v)
if plugin.QueenReem and msg then
pre_msg = plugin.QueenReem(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function QueenReem_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'QueenReem:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'QueenReem:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."QueenReem:QueenReem:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."QueenReem:QueenReem:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."QueenReem:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'QueenReem:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'QueenReem:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'QueenReem:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'QueenReem:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."QueenReem:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."QueenReem:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."QueenReem:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."QueenReem:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."QueenReem:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."QueenReem:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."QueenReem:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."QueenReem:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."QueenReem:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."QueenReem:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."QueenReem:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."QueenReem:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."QueenReem:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."QueenReem:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."QueenReem:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."QueenReem:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."QueenReem:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."QueenReem:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."QueenReem:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."QueenReem:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."QueenReem:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."QueenReem:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."QueenReem:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."QueenReem:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."QueenReem:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."QueenReem:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."QueenReem:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"• تم الغاء وضع الوصف") 
database:del(bot_id.."QueenReem:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."QueenReem:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."QueenReem:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"• تم الغاء حفظ الترحيب") 
database:del(bot_id.."QueenReem:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."QueenReem:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."QueenReem:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"• تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."QueenReem:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"• تم الغاء حفظ الرابط")       
database:del(bot_id.."QueenReem:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
...
if database:get(bot_id.."QueenReem:QueenReem:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه للخاص") 
database:del(bot_id.."QueenReem:QueenReem:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'QueenReem:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."QueenReem:QueenReem:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."QueenReem:QueenReem:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."QueenReem:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."QueenReem:QueenReem:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."QueenReem:QueenReem:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."QueenReem:QueenReem:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."QueenReem:QueenReem:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."QueenReem:UsersBot")   
...
local QueenReem_Msg = database:sismember(bot_id.."QueenReem:List:Filter:text"..msg.chat_id_,text) 
if QueenReem_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."QueenReem:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."QueenReem:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."QueenReem:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
dofile("QueenReem.lua") 
dofile("sudo.lua")  
send(msg.chat_id_, msg.id_,"*✅┇Ok Done rested bot my dev ..*")
end
if database:get(bot_id.."QueenReem:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء حفظ اسم البوت") 
database:del(bot_id.."QueenReem:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."QueenReem:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."QueenReem:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "• تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."QueenReem:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."QueenReem:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"• ارسل الامر الجديد")  
database:del(bot_id.."QueenReem:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."QueenReem:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."QueenReem:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."QueenReem:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"• تم حفظ الامر")  
database:del(bot_id.."QueenReem:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."QueenReem:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."QueenReem:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."QueenReem:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."QueenReem:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."QueenReem:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."QueenReem:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."QueenReem:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."QueenReem:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."QueenReem:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."QueenReem:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."QueenReem:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'QueenReem:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."QueenReem:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."QueenReem:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."QueenReem:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."QueenReem:Lock:Bot:kick"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","• تم فـتح البوتات")  
return false
end 
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس كوين ريم' or text == 'اريد بوت تمبلر' or text == 'سورس كوين ريم' then
Text = [[
•- DEV @Q_Z_T مبرمج بوتات•
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'اريد انصب بوت' or text == 'عجبني البوت' or text == 'منو منصبلك' or text == 'منو مطوره السورس' or text == 'مو سورس ظيم' or text == 'انصبلك'  or text == 'انصبلك بوت' then
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس كوين ريم
احدث واسرع البوتات وضمان الثقه
للاستفسار راسل المطور @Q_Z_T
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
database:del(bot_id.."QueenReem:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."QueenReem:lockpin"..msg.chat_id_)  
database:srem(bot_id.."QueenReem:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."QueenReem:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."QueenReem:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'QueenReem:'..lock..msg.chat_id_)    
end
...
database:del(bot_id.."QueenReem:Lock:Link"..msg.chat_id_)  
...
database:del(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_)  
...
database:del(bot_id.."QueenReem:Lock:Animation"..msg.chat_id_)  
...
database:del(bot_id.."QueenReem:Lock:Sticker"..msg.chat_id_)  
...
database:hset(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_ ,"flood","kick")  
...
database:hset(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_ ,"flood","del")  
...
database:hset(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_ ,"flood","keed")  
...
database:hset(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_ ,"flood","mute")  
...
database:hdel(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_ ,"flood")  
...
function Function_QueenReem(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_QueenReem, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_QueenReem, nil)
return false 
end
...
if text == ("الثانويين") and DevQueenReem(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\n*• قائمة مطورين الثانويين للبوت *\n*  ━═━═━═━*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."QueenReem:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
if text == ("مسح قائمه العام") and DevQueenReem(msg) then
database:del(bot_id.."QueenReem:GBan:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevQueenReem(msg) then
database:del(bot_id.."QueenReem:Sudo:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح قائمة المطورين  ")
end
if text == "مسح المنشئين الاساسين" and DevBot(msg) then
database:del(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_)
...
database:del(bot_id.."QueenReem:Constructor"..msg.chat_id_)
...
database:del(bot_id.."QueenReem:Manager"..msg.chat_id_)
...
database:del(bot_id.."QueenReem:Mod:User"..msg.chat_id_)
...
database:del(bot_id.."QueenReem:Special:User"..msg.chat_id_)
...
database:del(bot_id.."QueenReem:Muted:User"..msg.chat_id_)
...
database:del(bot_id.."QueenReem:Ban:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "\n• تم مسح المحظورين")
end
if text == ("قائمه العام") and DevQueenReem(msg) then
local list = database:smembers(bot_id.."QueenReem:GBan:User")
t = "\n• قائمة المحظورين عام \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."QueenReem:User:Name" .. v)
if username then
...
if text == ("المطورين") and DevQueenReem(msg) then
local list = database:smembers(bot_id.."QueenReem:Sudo:User")
t = "\n• قائمة مطورين البوت \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."QueenReem:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."QueenReem:Constructor"..msg.chat_id_)
t = "\n• قائمة المنشئين \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."QueenReem:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."QueenReem:Manager"..msg.chat_id_)
t = "\n• قائمة المدراء \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."QueenReem:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."QueenReem:Mod:User"..msg.chat_id_)
t = "\n• قائمة الادمنيه \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."QueenReem:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."QueenReem:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."QueenReem:Muted:User"..msg.chat_id_)
t = "\n• قائمة المكتومين \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."QueenReem:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."QueenReem:Ban:User"..msg.chat_id_)
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevQueenReem(msg) then
function Function_QueenReem(extra, result, success)
...
database:sadd(bot_id.."QueenReem:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and DevQueenReem(msg) then
...
if result.id_ == tonumber(1228539327) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطوره السورس \n")
return false 
end
...
database:sadd(bot_id.."QueenReem:GBan:User", result.id_)
...
database:sadd(bot_id.."QueenReem:GBan:User", userid)
Reply_Status(msg,userid,"reply","• تم حظره عام من المجموعات")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevQueenReem(msg) then
function Function_QueenReem(extra, result, success)
database:srem(bot_id.."QueenReem:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_QueenReem, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and DevQueenReem(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_QueenReem(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","• تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."QueenReem:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"• لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevQueenReem(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."QueenReem:GBan:User", userid)
Reply_Status(msg,userid,"reply","• تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevQueenReem(msg) then
function Function_QueenReem(extra, result, success)
database:sadd(bot_id.."QueenReem:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم رفعه مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_QueenReem, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and DevQueenReem(msg) then
...
database:sadd(bot_id.."QueenReem:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and DevQueenReem(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."QueenReem:Sudo:User", userid)
Reply_Status(msg,userid,"reply","• تم رفعه مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevQueenReem(msg) then
function Function_QueenReem(extra, result, success)
database:srem(bot_id.."QueenReem:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_QueenReem, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevQueenReem(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_QueenReem(extra, result, success)
if result.id_ then
database:srem(bot_id.."QueenReem:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and DevQueenReem(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."QueenReem:Sudo:User", userid)
...
function Function_QueenReem(extra, result, success)
database:sadd(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_QueenReem(extra, result, success)
database:srem(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
{text = URL.escape(titlech),url='https://telegram.me/'..database:get(bot_id..'add:ch:username'):gsub("@","")}}}   
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape('*˛ 𝖧𝗂 𝖻𝗋𝗈 𝗒𝗈𝗎 𝗁𝖺𝗏𝖾 𝗍𝗈 𝗌𝗎𝖻𝗌𝖼𝗋𝗂𝖻?? 𝗍𝗈 𝗍𝗁𝖾 𝖻𝗈𝗍 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 .*').."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
function Function_QueenReem(extra, result, success)
if result.id_ then
database:srem(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_QueenReem(extra, result, success)
database:sadd(bot_id.."QueenReem:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."QueenReem:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."QueenReem:Constructor"..msg.chat_id_, userid)
...
function Function_QueenReem(extra, result, success)
database:srem(bot_id.."QueenReem:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_QueenReem, nil)
end
...
function Function_QueenReem(extra, result, success)
if result.id_ then
database:srem(bot_id.."QueenReem:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","• تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"• لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."QueenReem:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","• تم تنزيله من المنشئين")  
end
...
function Function_QueenReem(extra, result, success)
database:sadd(bot_id.."QueenReem:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."QueenReem:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."QueenReem:Manager"..msg.chat_id_, userid)
...
function Function_QueenReem(extra, result, success)
database:srem(bot_id.."QueenReem:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_QueenReem(extra, result, success)
if result.id_ then
database:srem(bot_id.."QueenReem:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."QueenReem:Manager"..msg.chat_id_, userid)
...
function Function_QueenReem(extra, result, success)
database:sadd(bot_id.."QueenReem:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."QueenReem:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."QueenReem:Mod:User"..msg.chat_id_, userid)
...
function Function_QueenReem(extra, result, success)
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_QueenReem(extra, result, success)
if result.id_ then
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, userid)
...
function Function_QueenReem(extra, result, success)
database:sadd(bot_id.."QueenReem:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."QueenReem:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."QueenReem:Special:User"..msg.chat_id_, userid)
...
function Function_QueenReem(extra, result, success)
database:srem(bot_id.."QueenReem:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_QueenReem(extra, result, success)
if result.id_ then
database:srem(bot_id.."QueenReem:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."QueenReem:Special:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."QueenReem:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_) 
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local UserName = (data.username_ or "QueenReem_Source")
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس كوين ريم ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس كوين ريم ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '• مـلٱذ ، كࢪاهيةه  ', url="t.me/Q_Z_T"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'مطوره السورس' or text == "مطوره السورس" then
local msg_id = msg.id_/2097152/0.5
local Text = [[
¹𖠵
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• مـلٱذ ، كࢪاهيةه   ',url="t.me/Q_Z_T"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Q_Z_T&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
database:sadd(bot_id.."QueenReem:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."QueenReem:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."QueenReem:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."QueenReem:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."QueenReem:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local UserName = (data.username_ or "QueenReem_Source")
local NameUserr = "\n• المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")\n"
local keyboard = {}
...
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_, result.id_)
tdcli_function ({ID = "GetUser",user_id_ = result.id_},function(arg,data) 
local UserName = (data.username_ or "QueenReem_Source")
local NameUserr = "\n• المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")\n"
local keyboard = {}
...
database:sadd(bot_id.."QueenReem:Muted:User"..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
local UserName = (data.username_ or "QueenReem_Source")
local NameUserr = "\n• المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")\n"
local keyboard = {}
...
function Function_QueenReem(extra, result, success)
database:srem(bot_id.."QueenReem:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_QueenReem(extra, result, success)
if result.id_ then
database:srem(bot_id.."QueenReem:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."QueenReem:Muted:User"..msg.chat_id_, userid)
...
database:set(bot_id..'QueenReem:QueenReem:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","• تم قفل الفارسيه")  
end
if text and database:get(bot_id..'QueenReem:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'QueenReem:QueenReem:lock:Fshar'..msg.chat_id_) 
...
database:set(bot_id..'QueenReem:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","• تم قفل الفشار")  
end
if text and database:get(bot_id..'QueenReem:QueenReem:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'QueenReem:lock:Fshar'..msg.chat_id_) 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'QueenReem')..') '
...
if database:sismember(bot_id.."QueenReem:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."QueenReem:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."QueenReem:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"• انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"• ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:sadd(bot_id.."QueenReem:allM"..msg.chat_id_, msg.id_)
end
...
database:set(bot_id.."QueenReem:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."QueenReem:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."QueenReem:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."QueenReem:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."QueenReem:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."QueenReem:Chek:Welcome"..msg.chat_id_,true) 
...
database:del(bot_id.."QueenReem:Chek:Welcome"..msg.chat_id_) 
...
if Addictive(msg) then
database:del(bot_id.."QueenReem:Get:Welcome:Group"..msg.chat_id_) 
...
database:set(bot_id.."QueenReem:Filter:msg",msg.chat_id_)
...
local listtext = database:smembers(bot_id.."QueenReem:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."QueenReem:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."QueenReem:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."QueenReem:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."QueenReem:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."QueenReem:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."QueenReem:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."QueenReem:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:set(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"• تم منع الكلمه بنجاح")  
database:del(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."QueenReem:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."QueenReem:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."QueenReem:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."QueenReem:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
...
database:set(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false 
end
if text then 
local test = database:get(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منعها ")  
database:del(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."QueenReem:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منع المتحركه بنجاح ")  
database:del(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."QueenReem:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منع الملصق بنجاح ")  
database:del(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."QueenReem:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منع الصوره بنجاح ")  
database:del(bot_id.."QueenReem:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."QueenReem:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
if database:get(bot_id.."QueenReem:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "• تم الغاء حفظ القوانين") 
database:del(bot_id.."QueenReem:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."QueenReem:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."QueenReem:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."QueenReem:Set:Rules:Group"..msg.chat_id_) 
end
end
...
local Set_Rules = database:get(bot_id.."QueenReem:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_.."")
t = "• قائمه الاوامر المضافه  \n  ━═━═━═━\n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
local list = database:smembers(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"• تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "ترتيب الاوامر" and Constructor(msg) then
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"تفع")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"ر")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"تك")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":ت","تثبيت")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"ت")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":حذ","حذف رد")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"حذ")
database:set(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
database:sadd(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,"رد")
...
database:set(bot_id.."QueenReem:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
if Constructor(msg) then
database:set(bot_id.."QueenReem:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
function Function_QueenReem(extra, result, success)
database:sadd(bot_id.."QueenReem:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."QueenReem:MN:TF"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."QueenReem:MN:TF"..msg.chat_id_, userid)
...
function Function_QueenReem(extra, result, success)
database:srem(bot_id.."QueenReem:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
function Function_QueenReem(extra, result, success)
if result.id_ then
database:srem(bot_id.."QueenReem:MN:TF"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."QueenReem:MN:TF"..msg.chat_id_, userid)
...
local list = database:smembers(bot_id.."QueenReem:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."QueenReem:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
database:del(bot_id.."QueenReem:MN:TF"..msg.chat_id_)
...
local list = database:smembers(bot_id.."QueenReem:MN:TF"..msg.chat_id_)
t = "\n• قائمة المنظفين \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."QueenReem:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."QueenReem:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."QueenReem:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."QueenReem:Coomds"..msg.chat_id_)
end
...
database:set(bot_id.."QueenReem:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."QueenReem:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."QueenReem:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."QueenReem:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "• تم مسح الصلاحيه ") 
end
if database:get(bot_id.."QueenReem:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"• تم الغاء الامر ") 
database:del(bot_id.."QueenReem:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."QueenReem:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."QueenReem:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."QueenReem:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المطور الى -› "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."QueenReem:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المنشئ الاساسي الى -› "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."QueenReem:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المنشئ الى -› "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."QueenReem:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"• تم تغير رد المدير الى -› "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."QueenReem:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد الادمن الى -› "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."QueenReem:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المميز الى -› "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."QueenReem:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد العضو الى -› "..Teext)
end


if text == ("مسح ردود المدير") and BasicConstructor(msg) then
local list = database:smembers(bot_id.."QueenReem:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."QueenReem:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."QueenReem:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."QueenReem:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."QueenReem:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."QueenReem:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."QueenReem:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."QueenReem:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."QueenReem:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."QueenReem:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."QueenReem:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."QueenReem:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."QueenReem:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق•"
elseif database:get(bot_id.."QueenReem:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."QueenReem:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره•"
elseif database:get(bot_id.."QueenReem:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."QueenReem:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف•"
elseif database:get(bot_id.."QueenReem:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") -› {"..db.."}\n"
end
...
local test = database:get(bot_id.."QueenReem:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."QueenReem:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."QueenReem:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."QueenReem:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."QueenReem:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."QueenReem:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."QueenReem:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."QueenReem:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."QueenReem:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."QueenReem:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."QueenReem:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."QueenReem:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
database:set(bot_id.."QueenReem:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."QueenReem:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '• الان ارسل الرد الذي تريد اضافته \n• قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n• يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."QueenReem:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."QueenReem:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."QueenReem:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."QueenReem:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."QueenReem:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."QueenReem:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."QueenReem:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."QueenReem:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."QueenReem:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."QueenReem:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."QueenReem:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."QueenReem:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."QueenReem:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."QueenReem:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."QueenReem:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."QueenReem:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'QueenReem:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."QueenReem:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."QueenReem:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."QueenReem:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."QueenReem:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."QueenReem:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."QueenReem:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."QueenReem:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."QueenReem:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'QueenReem:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'QueenReem:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_,'['..Text..']')
database:sadd(bot_id.."QueenReem:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevQueenReem(msg) then 
local list = database:smembers(bot_id.."QueenReem:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."QueenReem:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."QueenReem:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."QueenReem:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."QueenReem:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."QueenReem:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."QueenReem:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."QueenReem:Add:Rd:Sudo:File"..v)
database:del(bot_id.."QueenReem:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."QueenReem:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"• تم مسح ردود المطور")
end
if text == ("ردود المطور") and DevQueenReem(msg) then 
local list = database:smembers(bot_id.."QueenReem:List:Rd:Sudo")
text = "\n• قائمة ردود المطور \n  ━═━═━═━\n"
for k,v in pairs(list) do
if database:get(bot_id.."QueenReem:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."QueenReem:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."QueenReem:Add:Rd:Sudo:stekr"..v) then
db = "ملصق•"
elseif database:get(bot_id.."QueenReem:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif database:get(bot_id.."QueenReem:Add:Rd:Sudo:Photo"..v) then
db = "صوره•"
elseif database:get(bot_id.."QueenReem:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."QueenReem:Add:Rd:Sudo:File"..v) then
db = "ملف•"
elseif database:get(bot_id.."QueenReem:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") -› {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."QueenReem:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."QueenReem:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."QueenReem:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."QueenReem:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."QueenReem:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."QueenReem:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."QueenReem:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."QueenReem:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."QueenReem:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"• تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد للكل" and DevQueenReem(msg) then 
send(msg.chat_id_, msg.id_,"• ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevQueenReem(msg) then 
send(msg.chat_id_, msg.id_,"• ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."QueenReem:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '• الان ارسل الرد الذي تريد اضافته \n• قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n• يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."QueenReem:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."QueenReem:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."QueenReem:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"• تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'QueenReem:'..v..text)
end
database:del(bot_id.."QueenReem:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."QueenReem:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."QueenReem:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'QueenReem:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."QueenReem:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."QueenReem:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."QueenReem:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."QueenReem:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."QueenReem:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."QueenReem:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."QueenReem:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."QueenReem:Add:Rd:Sudo:Audio"..text)
...
function Function_QueenReem(extra, result, success)
if DevQueenReeme(result.sender_user_id_)  then
...
if DevQueenReeme(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."QueenReem:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."QueenReem:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."QueenReem:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."QueenReem:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."QueenReem:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."QueenReem:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."QueenReem:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
...
function Function_QueenReem(extra, result, success)
if (result.id_) then
if DevQueenReeme(result.id_)  then
send(msg.chat_id_, msg.id_,"• لا تستطيع تنزيل مطور البوت او السورس")
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, Function_QueenReem, nil)
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."QueenReem:User:Name"..v.user_id_) then
t = t.."•┆"..x.."︙[@"..database:get(bot_id.."QueenReem:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
if not database:get(bot_id.."QueenReem:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."QueenReem:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
...
database:set(bot_id.."QueenReem:Kick:Me"..msg.chat_id_,true)  
Text = "\n• تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_QueenReem(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."QueenReem:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."QueenReem:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."QueenReem:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_QueenReem(extra, result, success)
if database:sismember(bot_id.."QueenReem:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."QueenReem:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."QueenReem:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."QueenReem:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."QueenReem:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
local UserName = (b.username_ or "malakAlDleMQueenReem007")
...
database:sadd(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."QueenReem:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"• تم مغادرة المجموعه") 
database:srem(bot_id.."QueenReem:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."QueenReem:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevQueenReem(msg) then   
database:del(bot_id.."QueenReem:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"• تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevQueenReem(msg) then  
database:set(bot_id.."QueenReem:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "• تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."QueenReem:Name:Bot") or "كوين ريم") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."QueenReem:Name:Bot") or "كوين ريم")
local namebot = {
"انه نايم نايم🦦",
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nارسل لي الكلمه الان ')
database:set(bot_id.."botss:QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:QueenReem:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:QueenReem:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:QueenReem:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:QueenReem:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:QueenReem:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:QueenReem:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:QueenReem:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:QueenReem:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and DevQueenReem(msg) then
 
local list = database:smembers(bot_id.."botss:QueenReem:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:QueenReem:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:QueenReem:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:QueenReem:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:QueenReem:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"تم حذف ردود المتعدده")
end
if text == ("الردود المتعدده") and DevQueenReem(msg) then
...
if text == "اضف رد متعدد" and DevQueenReem(msg) then
 
database:set(bot_id.."botss:QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الرد الذي اريد اضافته")
end
if text == "حذف رد متعدد" and DevQueenReem(msg) then
 
database:set(bot_id.."botss:QueenReem:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:QueenReem:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:QueenReem:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:QueenReem:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:QueenReem:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:QueenReem:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:QueenReem:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:QueenReem:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:QueenReem:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:QueenReem:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:QueenReem:Add:Rd:Sudo:Text2"..text)   
...
if DevQueenReem(msg) then
database:setex(bot_id.."QueenReem:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."QueenReem:Status:Bc") and not DevQueenReem(msg) then 
send(msg.chat_id_, msg.id_,"• الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."QueenReem:QueenReem:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."QueenReem:QueenReem:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n• للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."QueenReem:QueenReem:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n• للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."QueenReem:QueenReem:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."QueenReem:QueenReem:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevQueenReem(msg) then  
database:del(bot_id.."QueenReem:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n• تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevQueenReem(msg) then  
database:set(bot_id.."QueenReem:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n• تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."QueenReem:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."QueenReem:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."QueenReem:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."QueenReem:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."QueenReem:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."QueenReem:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."QueenReem:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."QueenReem:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."QueenReem:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."QueenReem:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."QueenReem:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."QueenReem:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."QueenReem:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."QueenReem:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."QueenReem:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."QueenReem:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."QueenReem:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."QueenReem:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."QueenReem:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."QueenReem:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."QueenReem:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."QueenReem:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."QueenReem:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."QueenReem:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."QueenReem:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."QueenReem:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."QueenReem:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."QueenReem:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."QueenReem:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."QueenReem:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n• ااعدادات المجموعه "..
"\n  ━═━═━═━"..
"\n• علامة ال {✓} تعني مفعل"..
...
database:set(bot_id.."QueenReem:Fun_Bots"..msg.chat_id_,"true")
end
...
database:del(bot_id.."QueenReem:Fun_Bots"..msg.chat_id_)
end
...
database:del(bot_id..'QueenReem:Lock:ID:Bot'..msg.chat_id_) 
...
database:set(bot_id..'QueenReem:Lock:ID:Bot'..msg.chat_id_,true) 
...
database:del(bot_id..'QueenReem:Lock:ID:Bot:Photo'..msg.chat_id_) 
...
database:set(bot_id..'QueenReem:Lock:ID:Bot:Photo'..msg.chat_id_,true) 
...
database:setex(bot_id.."QueenReem:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
• ارسل الان النص
• يمكنك اضافه :
- `#username` > اسم المستخدم
...
database:set(bot_id.."QueenReem:Klesh:Id:Bot"..msg.chat_id_,Text_Rand)
send(msg.chat_id_, msg.id_,'• تم تغير الايدي ارسل ايدي لرؤيته')
end
if text == 'حذف الايدي' or text == 'مسح الايدي' then
if Owner(msg) then
database:del(bot_id.."QueenReem:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '• تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."QueenReem:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"• تم الغاء تعين الايدي") 
database:del(bot_id.."QueenReem:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."QueenReem:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."QueenReem:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'• تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'QueenReem:Lock:ID:Bot'..msg.chat_id_) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local NumMsg = database:get(bot_id..'QueenReem:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."QueenReem:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'QueenReem:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."QueenReem:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."QueenReem:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."QueenReem:Klesh:Id:Bot"..msg.chat_id_) or database:get(bot_id.."QueenReem:KleshIDALLBOT")
if not database:get(bot_id..'QueenReem:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
if not database:get(bot_id..'QueenReem:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'QueenReem:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
local Id = data.id_
local NumMsg = database:get(bot_id..'QueenReem:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'QueenReem:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."QueenReem:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."QueenReem:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$")  and not database:get(bot_id..'QueenReem:Lock:ID:Bot'..msg.chat_id_) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'QueenReem:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '• عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'QueenReem:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '• تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'QueenReem:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '• عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'QueenReem:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '• تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."QueenReem:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '• عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'QueenReem:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."QueenReem:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."QueenReem:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."QueenReem:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and DevQueenReem(msg) then
local pv = database:smembers(bot_id..'QueenReem:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'QueenReem:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevQueenReem(msg) then
local group = database:smembers(bot_id..'QueenReem:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'QueenReem:Chek:Groups',group[i])  
w = w + 1
end
...
if text == ("تحديث السورس") and DevQueenReem(msg) then  
send(msg.chat_id_,msg.id_,'• تم التحديث')
os.execute('rm -rf QueenReem.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/QueenReem/QueenReem/master/QueenReem.lua')
os.execute('wget https://raw.githubusercontent.com/QueenReem/QueenReem/master/start.lua')
dofile('QueenReem.lua')  
return false
end
if text == "راسلني" then
...
database:set(bot_id.."QueenReem:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."QueenReem:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."QueenReem:zhrf_Bots"..msg.chat_id_) == "open" then
...
if Deett54 then
send(msg.chat_id_, msg.id_,'['..Deett54..']')
else
send(msg.chat_id_, msg.id_,'• لا تستطيع استخدام البوت \n•  يرجى الاشتراك بالقناه اولا \n•  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
• كشف الحيوان
• نسبه الغباء
• العاب متطوره - العاب كوين ريم](t.me/Deett54)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' ˛ 𝗅𝖺𝗋𝗂𝖼𝖺 𝗍𝖾𝖺𝗆 🦇.', url="t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
database:set(bot_id.."QueenReem:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Owner(msg) then
send(msg.chat_id_, msg.id_,'•  تم تفعيل الابراج')
database:set(bot_id.."QueenReem:brj_Bots"..msg.chat_id_,"open")
end
if text == "تعطيل كت تويت" and Owner(msg) then
send(msg.chat_id_, msg.id_, '•  تم تعطيل كت تويت')
database:set(bot_id.."QueenReem:Qut"..msg.chat_id_,true)
end
if text == "تفعيل كت تويت" and Owner(msg) then
send(msg.chat_id_, msg.id_,'•  تم تفعيل كت تويت')
database:del(bot_id.."QueenReem:Qut"..msg.chat_id_)
end
if text == "كت" or  text == "كت تويت" and not  database:get(bot_id.."QueenReem:Qut"..msg.chat_id_) then
...
if text and text:match("^برج (.*)$") and database:get(bot_id.."QueenReem:brj_Bots"..msg.chat_id_) == "open" then
...
if text == "الابراج" and database:get(bot_id.."QueenReem:brj_Bots"..msg.chat_id_) == "open" then
key = {
...
database:set(bot_id.."QueenReem:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."QueenReem:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."QueenReem:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."QueenReem:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الانستا')
database:set(bot_id.."QueenReem:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."QueenReem:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."QueenReem:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الافلام')
database:set(bot_id.."QueenReem:movie_bot"..msg.chat_id_,"open")
end

if text and text:match("^فلم (.*)$") and database:get(bot_id.."QueenReem:movie_bot"..msg.chat_id_) == "open" then
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and database:get(bot_id.."QueenReem:Lock:Xn"..msg.chat_id_)=="del" then      
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and database:get(bot_id.."QueenReem:Lock:Xn"..msg.chat_id_)=="del" then
photo_id = msg.content_.photo_.sizes_[1].photo_.persistent_id_  
Srrt = https.request('https://QueenReem-source.tk/malakAlDleMQueenReem007/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text == 'تفعيل البوت الخدمي' and DevQueenReem(msg) then  
database:del(bot_id..'QueenReem:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'• تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevQueenReem(msg) then  
database:set(bot_id..'QueenReem:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'• تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevQueenReem(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'QueenReem:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'• تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'QueenReem:Chek:Groups')  
local Users = database:scard(bot_id..'QueenReem:UsersBot')  
send(msg.chat_id_, msg.id_,'• احصائيات البوت \n\n• عدد المجموعات *~ '..Groups..'\n• عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه احتياطيه' and DevQueenReem(msg) then
local list = database:smembers(bot_id..'QueenReem:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'QueenReem Chat'
ASAS = database:smembers(bot_id.."QueenReem:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."QueenReem:Constructor"..v)
MDER = database:smembers(bot_id.."QueenReem:Manager"..v)
MOD = database:smembers(bot_id.."QueenReem:Mod:User"..v)
link = database:get(bot_id.."QueenReem:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"QueenReem":"'..NAME..'",'
else
t = t..',"'..v..'":{"QueenReem":"'..NAME..'",'
end
if #ASAS ~= 0 then 
...
local Text_Dev = database:get(bot_id..'QueenReem:Text_Dev')
if Text_Dev then 
...
if text == 'الملفات' and DevQueenReem(msg) then
t = '• جميع الملفات : \n  ━═━═━═━\n'
i = 0
for v in io.popen('ls QueenReem_Files'):lines() do
if v:match(".lua$") then
...
if DevQueenReem(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/malakAlDleMQueenReem007/Files_QueenReem/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n• اهلا بك في متجر ملفات كوين ريم\n• يوجد في المتجر ملف الردود\n• يتم ادراج الملفات في التحديثات القادمه \n  ━═━═━═━\n"
local TextE = "\n  ━═━═━═━\n• تدل علامة (✔) الملف مفعل\n".."• تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("QueenReem_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevQueenReem(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("QueenReem_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/malakAlDleMQueenReem007/Files_QueenReem/master/Files_QueenReem/"..file)
if res == 200 then
os.execute("rm -fr QueenReem_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('QueenReem.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevQueenReem(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/malakAlDleMQueenReem007/Files_QueenReem/master/Files_QueenReem/"..file)
if res == 200 then
local chek = io.open("QueenReem_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevQueenReem(msg) then
os.execute("rm -fr QueenReem_Files/*")
send(msg.chat_id_,msg.id_,"• تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevQueenReem(msg) then
local Users = database:smembers('QueenReem:'..bot_id.."userss")
local Groups = database:smembers('QueenReem:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'QueenReem:Chek:Groups',Groups[i])  
end
for i = 1, #Users do
database:sadd(bot_id..'QueenReem:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'• تم نقل : '..#Groups..' كروب\n• تم نقل : '..#Users..' مشترك \n• من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevQueenReem(msg) then
database:del(bot_id..'QueenReem:Text_Dev')
send(msg.chat_id_, msg.id_,'• تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevQueenReem(msg) then
database:set(bot_id..'QueenReem:Set:Text_Dev'..msg.chat_id_,true)
send(msg.chat_id_,msg.id_,'• ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'QueenReem:Set:Text_Dev'..msg.chat_id_) then
if text == 'الغاء' then 
database:del(bot_id..'QueenReem:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'• تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'QueenReem:Text_Dev',text)
database:del(bot_id..'QueenReem:Set:Text_Dev'..msg.chat_id_)
...
if text == 'العاب كوين ريم' or text == 'العاب متطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '  QueenReem Team  ', url="t.me/Deett54"}},
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
if text == 'رفع النسخه الاحتياطيه' and DevQueenReem(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevQueenReem(msg) then
dofile("QueenReem.lua")  
send(msg.chat_id_, msg.id_, "• تم التحديث")
end

if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' then  
local url,res = https.request('https://evzxar.ml/QueenReem.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.QueenReem ~= true then
send(msg.chat_id_,msg.id_,'• لا يمكنك استخدام البوت\n• عليك الاشتراك في قناة السورس\n• لتتمكن من استخدام الاوامر \n• CH ~ [@Deett54]')   
return false 
end
Text = [[
*𝗝ْ𝗨ِst #َ𝗚𝗿ِ𝗼𝘂ِ𝗽َُ!ْ𝗦 𝗧ِ𝘂ِ𝗺ّ𝗯َ𝗹َُ!r⤹* [𝗊𝗎𝖾𝖾𝗇 𝗋𝖾𝖾𝗆](t.me/Deett54)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝗊𝗎𝖾𝖾𝗇 𝗋𝖾𝖾𝗆',url="https://t.me/Deett54"},
},
{
{text = '𝖽𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋',url="https://t.me/Q_Z_T"},
},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Deett54&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'QueenReem:Num:Add:Bot') or 0) and not DevQueenReem(msg) then
send(msg.chat_id_, msg.id_,'• عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'QueenReem:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'QueenReem:Chek:Groups',msg.chat_id_) then
...
keyboard.inline_keyboard = {
{
{text = '  معرفة المزيد ؟',url="https://t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
database:sadd(bot_id..'QueenReem:Chek:Groups',msg.chat_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'QueenReem:Chek:Groups',msg.chat_id_) then
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'QueenReem:Free:Add:Bots') then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
database:sadd(bot_id..'QueenReem:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'QueenReem:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'QueenReem:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'QueenReem:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if text == '/play' then
...
keyboard.inline_keyboard = {
{
{text = '   معرفة المزيد ؟',url="t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Sf = database:get(bot_id.."QueenReem:Filter:msg")
local list = database:smembers(bot_id.."QueenReem:List:Filter:Photo"..Sf)  
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."QueenReem:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."QueenReem:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."QueenReem:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if not DevQueenReem(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."QueenReem:Filter"..msg.sender_user_id_) then
...
if DevQueenReem(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text and text:match("^- تغير الاشتراك• .$") and DevQueenReem(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رساله الاشتراك• .$") and DevQueenReem(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك• ." and DevQueenReem(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "• تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك• .$") and DevQueenReem(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري• ." and DevQueenReem(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- تعطيل الاشتراك الاجباري• ." and DevQueenReem(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "• تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- الاشتراك الاجباري• ." and DevQueenReem(msg) then  
...
database:srem(bot_id..'QueenReem:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
database:srem(bot_id.."QueenReem:Muted:User"..data.chat_id_, Userid[2])
...
if tonumber(Userid[1]) == tonumber(data.sender_user_id_) then
database:srem(bot_id.."QueenReem:Ban:User"..data.chat_id_, Userid[2])
...
database:del(bot_id.."QueenReem:Basic:Constructor"..data.chat_id_)
Edit_Msgees("sendok",data.chat_id_,data.sender_user_id_,data.message_id_, "🗑꒐ تم مسح القائمة")
end
end
...
database:del(bot_id.."QueenReem:Constructor"..data.chat_id_)
Edit_Msgees("sendok",data.chat_id_,data.sender_user_id_,data.message_id_, "🗑꒐ تم مسح القائمة")
end
end
...
database:set(bot_id.."QueenReem:Lock:text"..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/QueenReem:Link_Group') then
if tonumber(Text:match('(.*)/QueenReem:Link_Group')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:Link_Group"..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/QueenReem:Chek:Welcome') then
if tonumber(Text:match('(.*)/QueenReem:Chek:Welcome')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:Chek:Welcome"..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/QueenReem:Reply:Manager') and Owner(data) then
if tonumber(Text:match('(.*)/QueenReem:Reply:Manager')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."QueenReem:Reply:Manager"..data.chat_id_)  
...
elseif Text and Text:match('(.*)/QueenReem:Reply:Sudo') and Owner(data) then
if tonumber(Text:match('(.*)/QueenReem:Reply:Sudo')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."QueenReem:Reply:Sudo"..data.chat_id_)  
...
elseif Text and Text:match('(.*)/QueenReem:Kick:Me') then
if tonumber(Text:match('(.*)/QueenReem:Kick:Me')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."QueenReem:Kick:Me"..data.chat_id_)  
...
elseif Text and Text:match('(.*)/QueenReem:Left:Bot') and DevQueenReem(data) then  
if tonumber(Text:match('(.*)/QueenReem:Left:Bot')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."QueenReem:Left:Bot"..data.chat_id_)  
...
elseif Text and Text:match('(.*)/QueenReem:Status:Bc') and DevQueenReem(data) then  
if tonumber(Text:match('(.*)/QueenReem:Status:Bc')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."QueenReem:Status:Bc") 
...
elseif Text and Text:match('(.*)/QueenReem:Fun_Bots') and Owner(data) then    
if tonumber(Text:match('(.*)/QueenReem:Fun_Bots')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."QueenReem:Fun_Bots"..data.chat_id_)
...
elseif Text and Text:match('(.*)/QueenReem:Lock:ID:Bot') and Owner(data) then  
if tonumber(Text:match('(.*)/QueenReem:Lock:ID:Bot')) == tonumber(data.sender_user_id_) then
database:del(bot_id..'QueenReem:Lock:ID:Bot'..data.chat_id_) 
...
elseif Text and Text:match('(.*)/QueenReem:Lock:ID:Bot:Photo') and Owner(data) then  
if tonumber(Text:match('(.*)/QueenReem:Lock:ID:Bot:Photo')) == tonumber(data.sender_user_id_) then
database:del(bot_id..'QueenReem:Lock:ID:Bot:Photo'..data.chat_id_) 
...
elseif Text and Text:match('(.*)/QueenReem:zhrf_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/QueenReem:zhrf_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:zhrf_Bots"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/QueenReem:brj_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/QueenReem:brj_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:brj_Bots"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/QueenReem:age_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/QueenReem:age_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:age_Bots"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/QueenReem:movie_bot') and Owner(data) then
if tonumber(Text:match('(.*)/QueenReem:movie_bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:movie_bot"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/QueenReem:Free:Add:Bots') and DevQueenReem(data) then  
if tonumber(Text:match('(.*)/QueenReem:Free:Add:Bots')) == tonumber(data.sender_user_id_) then
database:del(bot_id..'QueenReem:Free:Add:Bots') 
...
elseif Text and Text:match('(.*)/QueenReem:insta_bot') and Owner(data) then
if tonumber(Text:match('(.*)/QueenReem:insta_bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:insta_bot"..data.chat_id_,"open")
...
elseif Text and Text:match('(.*)/unQueenReem:Link_Group') then
if tonumber(Text:match('(.*)/unQueenReem:Link_Group')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."QueenReem:Link_Group"..data.chat_id_) 
...
elseif Text and Text:match('(.*)/unQueenReem:Chek:Welcome') then
if tonumber(Text:match('(.*)/unQueenReem:Chek:Welcome')) == tonumber(data.sender_user_id_) then
database:del(bot_id.."QueenReem:Chek:Welcome"..data.chat_id_) 
...
elseif Text and Text:match('(.*)/unQueenReem:Reply:Manager') and Owner(data) then
if tonumber(Text:match('(.*)/unQueenReem:Reply:Manager')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:Reply:Manager"..data.chat_id_,true)  
...
elseif Text and Text:match('(.*)/unQueenReem:Reply:Sudo') and Owner(data) then
if tonumber(Text:match('(.*)/unQueenReem:Reply:Sudo')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:Reply:Sudo"..data.chat_id_,true)   
...
elseif Text and Text:match('(.*)/unQueenReem:Kick:Me') then
if tonumber(Text:match('(.*)/unQueenReem:Kick:Me')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:Kick:Me"..data.chat_id_,true)  
...
elseif Text and Text:match('(.*)/unQueenReem:Left:Bot') and DevQueenReem(data) then  
if tonumber(Text:match('(.*)/unQueenReem:Left:Bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:Left:Bot"..data.chat_id_,true)   
...
elseif Text and Text:match('(.*)/unQueenReem:Status:Bc') and DevQueenReem(data) then  
if tonumber(Text:match('(.*)/unQueenReem:Status:Bc')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:Status:Bc",true) 
...
elseif Text and Text:match('(.*)/unQueenReem:Fun_Bots') and Owner(data) then    
if tonumber(Text:match('(.*)/unQueenReem:Fun_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:Fun_Bots"..data.chat_id_,"true")
...
elseif Text and Text:match('(.*)/unQueenReem:Lock:ID:Bot') and Owner(data) then  
if tonumber(Text:match('(.*)/unQueenReem:Lock:ID:Bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id..'QueenReem:Lock:ID:Bot'..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/unQueenReem:Lock:ID:Bot:Photo') and Owner(data) then  
if tonumber(Text:match('(.*)/unQueenReem:Lock:ID:Bot:Photo')) == tonumber(data.sender_user_id_) then
database:set(bot_id..'QueenReem:Lock:ID:Bot:Photo'..data.chat_id_,true) 
...
elseif Text and Text:match('(.*)/unQueenReem:zhrf_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/unQueenReem:zhrf_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:zhrf_Bots"..data.chat_id_,"close")
...
elseif Text and Text:match('(.*)/unQueenReem:brj_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/unQueenReem:brj_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:brj_Bots"..data.chat_id_,"close")
...
elseif Text and Text:match('(.*)/unQueenReem:age_Bots') and Owner(data) then
if tonumber(Text:match('(.*)/unQueenReem:age_Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:age_Bots"..data.chat_id_,"close")
...
elseif Text and Text:match('(.*)/unQueenReem:movie_bot') and Owner(data) then
if tonumber(Text:match('(.*)/unQueenReem:movie_bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:movie_bot"..data.chat_id_,"close")
...
elseif Text and Text:match('(.*)/unQueenReem:Free:Add:Bots') and DevQueenReem(data) then  
if tonumber(Text:match('(.*)/unQueenReem:Free:Add:Bots')) == tonumber(data.sender_user_id_) then
database:set(bot_id..'QueenReem:Free:Add:Bots',true) 
...
elseif Text and Text:match('(.*)/unQueenReem:insta_bot') and Owner(data) then
if tonumber(Text:match('(.*)/unQueenReem:insta_bot')) == tonumber(data.sender_user_id_) then
database:set(bot_id.."QueenReem:insta_bot"..data.chat_id_,"close")
...
{
{text = 'تفعيل الرابط', callback_data=data.sender_user_id_.."/QueenReem:Link_Group"},{text = 'تعطيل الرابط', callback_data=data.sender_user_id_.."/unQueenReem:Link_Group"},
},
{
{text = 'تفعيل الترحيب', callback_data=data.sender_user_id_.."/QueenReem:Chek:Welcome"},{text = 'تعطيل الترحيب', callback_data=data.sender_user_id_.."/unQueenReem:Chek:Welcome"},
},
{
{text = 'تفعيل ردود المدير', callback_data=data.sender_user_id_.."/QueenReem:Reply:Manager"},{text = 'تعطيل ردود المدير', callback_data=data.sender_user_id_.."/unQueenReem:Reply:Manager"},
},
{
{text = 'تفعيل ردود المطور', callback_data=data.sender_user_id_.."/QueenReem:Reply:Sudo"},{text = 'تعطيل ردود المطور', callback_data=data.sender_user_id_.."/unQueenReem:Reply:Sudo"},
},
{
{text = 'تفعيل اطردني', callback_data=data.sender_user_id_.."/QueenReem:Kick:Me"},{text = 'تعطيل اطردني', callback_data=data.sender_user_id_.."/unQueenReem:Kick:Me"},
},
{
{text = 'تفعيل المغادره', callback_data=data.sender_user_id_.."/QueenReem:Left:Bot"},{text = 'تعطيل المغادره', callback_data=data.sender_user_id_.."/unQueenReem:Left:Bot"},
},
{
{text = 'تفعيل الاذاعه', callback_data=data.sender_user_id_.."/QueenReem:Status:Bc"},{text = 'تعطيل الاذاعه', callback_data=data.sender_user_id_.."/unQueenReem:Status:Bc"},
},
{
{text = 'تفعيل اوامر التحشيش', callback_data=data.sender_user_id_.."/QueenReem:Fun_Bots"},{text = 'تعطيل اوامر التحشيش', callback_data=data.sender_user_id_.."/unQueenReem:Fun_Bots"},
},
{
{text = 'تفعيل الايدي ', callback_data=data.sender_user_id_.."/QueenReem:Lock:ID:Bot"},{text = 'تعطيل الايدي', callback_data=data.sender_user_id_.."/unQueenReem:Lock:ID:Bot"},
},
{
{text = 'تفعيل الايدي بالصوره', callback_data=data.sender_user_id_.."/QueenReem:Lock:ID:Bot:Photo"},{text = 'تعطيل الايدي بالصوره', callback_data=data.sender_user_id_.."/unQueenReem:Lock:ID:Bot:Photo"},
},
{
...
{
{text = 'تفعيل للزخرفه', callback_data=data.sender_user_id_.."/QueenReem:zhrf_Bots"},{text = 'تعطيل الزخرفه', callback_data=data.sender_user_id_.."/unQueenReem:zhrf_Bots"},
},
{
{text = 'تفعيل الابراج', callback_data=data.sender_user_id_.."/QueenReem:brj_Bots"},{text = 'تعطيل الابراج', callback_data=data.sender_user_id_.."/unQueenReem:brj_Bots"},
},
{
{text = 'تفعيل حساب العمر', callback_data=data.sender_user_id_.."/QueenReem:age_Bots"},{text = 'تعطيل حساب للعمر', callback_data=data.sender_user_id_.."/unQueenReem:age_Bots"},
},
{
{text = 'تفعيل الافلام', callback_data=data.sender_user_id_.."/QueenReem:movie_bot"},{text = 'تعطيل الافلام', callback_data=data.sender_user_id_.."/unQueenReem:movie_bot"},
},
{
{text = 'تفعيل البوت الخدمي', callback_data=data.sender_user_id_.."/QueenReem:Free:Add:Bots"},{text = 'تعطيل البوت الخدمي', callback_data=data.sender_user_id_.."/unQueenReem:Free:Add:Bots"},
},
{
{text = 'تفعيل الانستا', callback_data=data.sender_user_id_.."/QueenReem:insta_bot"},{text = 'تعطيل الانستا', callback_data=data.sender_user_id_.."/unQueenReem:insta_bot"},
},
{
...
local NumMsg = database:get(bot_id..'QueenReem:messageUser'..data.chat_id_..':'..data.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."QueenReem:Comd:New:rt:User:"..data.chat_id_..Id) or Get_Rank(Id,data.chat_id_)
local message_edit = database:get(bot_id..'QueenReem:message_edit'..data.chat_id_..data.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."QueenReem:Add:Num"..data.chat_id_..data.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."QueenReem:Add:Memp"..data.chat_id_..":"..data.sender_user_id_) or 0
local Total_Photp = (IZlZ7I.total_count_ or 0)
local Texting = {
'ئمنورني يا وردة 🤣💝',
"تراا أوفر؟ 🦦🤍 ",
...
local Teext =[[
𝙒𝙚𝙡𝘾𝙤𝙢𝙚 𝙏𝙤 𝙎𝙤𝙪𝙍𝙘𝙚 [𓌹 𝘓𝘢𝘙𝘪𝘤𝘢 𓌺 🦇](t.me/Deett54)
...
{
{text = '𝖽𝗂𝗌𝗋𝗎𝗉𝗍𝗂𝗈𝗇 𝗈𝗋𝖽𝖾𝗋𝗌', callback_data=data.sender_user_id_.."/homeaddwd"},{text = '𝗅𝗈𝖼𝗄 𝗈𝗋𝖽??𝗋𝗌', callback_data=data.sender_user_id_.."/homelocks"},
},
{
{text = '- ⤹ ٰ𝖱ِ𝖊َ𝖳ِ𝖚ٍ𝐑ِɴ 🔁.', callback_data=data.sender_user_id_.."/help"},
},
...
inline = {
{{text = '• QueenReem 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/Deett54'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."QueenReem:List:Filter:Animation"..idchci,animation)  
end
if DAata and DAata:match("^pito(.*)$") and Addictive(data) then  
local idchci = database:get(bot_id.."QueenReem:Filter:msg")
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."QueenReem:List:Filter:Photo"..idchci,photo)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."QueenReem:List:Filter:Sticker"..idchci,Sticker)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listSticker = database:smembers(bot_id.."QueenReem:List:Filter:Sticker"..delallSticker)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."QueenReem:List:Filter:Sticker"..delallSticker,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listAnimation = database:smembers(bot_id.."QueenReem:List:Filter:Animation"..delallmation)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."QueenReem:List:Filter:Animation"..delallmation,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listPhoto = database:smembers(bot_id.."QueenReem:List:Filter:Photo"..delallph)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."QueenReem:List:Filter:Photo"..delallph,v)  
end  
end
end
...
if text and not database:sismember(bot_id..'QueenReem:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'QueenReem:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'QueenReem:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."QueenReem:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."QueenReem:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."QueenReem:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."QueenReem:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."QueenReem:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."QueenReem:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."QueenReem:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."QueenReem:Name:Bot") or "كوين ريم")
if not database:get(bot_id.."QueenReem:Fun_Bots"..msg.chat_id_) then
...
keyboard.inline_keyboard = {
{
{text = '• '..sendnum..'%',url="https://t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '• '..sendnuj..'%',url="https://t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = ''..sendnmj..' ‹‹-',url="https://t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = ''..sendnuk..' ‹‹-',url="https://t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '• '..sendnnk..'%',url="https://t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '• '..sendzff..'%',url="https://t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '• '..sendhen..'%',url="https://t.me/Deett54"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
------------------------------------------------------------------------
QueenReem_Started_Bot(msg,data)
QueenReem_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'QueenReem:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."QueenReem:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
local list = database:smembers(bot_id.."QueenReem:Basic:Constructor"..msg.chat_id_)
t = "• المنشئين الاساسين تعالو مخرب \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."QueenReem:User:Name" .. v)
...
if database:get(bot_id.."QueenReem:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."QueenReem:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."QueenReem:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."QueenReem:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local QueenReem_Msg = database:sismember(bot_id.."QueenReem:List:Filter:text"..result.chat_id_,text) 
if QueenReem_Msg then    
...
if msg.content_.ID == 'MessageAnimation' then    
local Animation_Msg = database:sismember(bot_id.."QueenReem:List:Filter:Animation"..result.chat_id_,result.content_.animation_.animation_.persistent_id_) 
...
if msg.content_.ID == 'MessagePhoto' then    
local Photo_Msg = database:sismember(bot_id.."QueenReem:List:Filter:Photo"..result.chat_id_,result.content_.photo_.sizes_[1].photo_.persistent_id_) 
if Photo_Msg then    
...
if msg.content_.ID == 'MessageSticker' then    
local Sticker_Msg = database:sismember(bot_id.."QueenReem:List:Filter:Sticker"..result.chat_id_,result.content_.sticker_.sticker_.persistent_id_) 
if Sticker_Msg then    
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'QueenReem:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'QueenReem:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'QueenReem:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
print("\27[34m"..[[
>> The Bot is Running
>> Bot source > QueenReem
>>Source channel > @Deett54
>>Source developer > @Q_Z_T
╔╗─╔══╗╔═╗╔══╗╔═╗╔══╗
║║─║╔╗║║╬║╚║║╝║╔╝║╔╗║
║╚╗║╠╣║║╗╣╔║║╗║╚╗║╠╣║
╚═╝╚╝╚╝╚╩╝╚══╝╚═╝╚╝╚╝
...
database:srem(bot_id..'QueenReem:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'QueenReem:Chek:Groups',v)  
end
...
database:sadd(bot_id..'QueenReem:Chek:Groups',v)  
end end,nil)
